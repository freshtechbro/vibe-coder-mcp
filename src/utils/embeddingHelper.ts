...
class EmbeddingPipeline {
  ...
  // Changed Function type to any for simplicity as it's unused
  static async getInstance(progress_callback: any | null = null): Promise<FeatureExtractionPipeline> {
    if (this.instance === null) {
      ...
      try {
        ...
        const options: { progress_callback?: any } = {};
