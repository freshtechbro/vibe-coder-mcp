...
interface MockOptions {
  ...
  model?: string | RegExp;
  /** The content to be placed in choices[0].message.content. If an object, it will be JSON.stringified. */
...
export function mockOpenRouterResponse(options: MockOptions): void {
  ...
  // Use mockImplementation to handle different calls based on URL and potentially model
  // Use the public AxiosRequestConfig for the parameter type to match common usage
